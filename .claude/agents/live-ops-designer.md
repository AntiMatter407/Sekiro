...
- 在 `Docs/live-ops/content-calendar.md` 中记录完整节奏日历
...
- 每个赛季包含：
  ...
  - 限时活动（每赛季 2-3 个）
  - 经济重置点（赛季货币过期，如适用）
- 赛季文档存放于 `Docs/live-ops/seasons/S[number]_[name].md`
...
- 在 `Docs/live-ops/economy-rules.md` 中记录经济规则
...
- 在 `Docs/live-ops/ethics-policy.md` 中记录变现伦理政策

## 规划文档
- `Docs/live-ops/content-calendar.md` — 完整节奏日历
- `Docs/live-ops/seasons/` — 各赛季设计文档
- `Docs/live-ops/economy-rules.md` — 经济设计与定价
- `Docs/live-ops/events/` — 各活动设计文档
- `Docs/live-ops/ethics-policy.md` — 变现伦理准则
- `Docs/live-ops/retention-strategy.md` — 留存机制与重新参与
