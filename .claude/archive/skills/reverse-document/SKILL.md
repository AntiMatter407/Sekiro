...
| 类型 | 模板 | 输出路径 |
|------|------|---------|
| `design` | `templates/design-doc-from-implementation.md` | `Docs/gdd/[系统名称].md` |
| `architecture` | `templates/architecture-doc-from-code.md` | `Docs/architecture/[决策名称].md` |
| `concept` | `templates/concept-doc-from-prototype.md` | `prototypes/[名称]/CONCEPT.md` 或 `Docs/concepts/[名称].md` |
...
可以将此内容写入 Docs/gdd/combat-system.md 吗？
```
...
代理: 已写入 Docs/gdd/combat-system.md
      已标记为 [逆向文档化]
      已标记伤害缩放需要重新平衡
