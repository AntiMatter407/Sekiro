...
**所需工件：**
- [ ] `Docs/gdd/game-concept.md` 存在且有内容
- [ ] 游戏支柱已定义（在概念文档或 `Docs/gdd/game-pillars.md` 中）
...
**所需工件：**
- [ ] 系统索引存在于 `Docs/gdd/systems-index.md`，至少枚举了 MVP 系统列表
- [ ] `Docs/gdd/` 中至少有 1 份 GDD（game-concept.md 和 systems-index.md 之外的）
...
**所需工件：**
- [ ] `src/` 中有按子系统组织的有效代码
- [ ] GDD 中的所有核心机制已实现（交叉比对 `Docs/gdd/` 与 `src/`）
- [ ] 主要游玩路径可从头玩到尾
- [ ] 测试文件存在于 `tests/`
...
### 所需工件：[X/Y 项已就绪]
- [x] Docs/gdd/game-concept.md — 已存在，2.4KB
