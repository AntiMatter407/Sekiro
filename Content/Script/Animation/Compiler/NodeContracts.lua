...
local contracts = {
    ...
    SequencePlayer = {
        ...
        Properties = {
            ...
            { Name = "GroupName", ValueType = "Name", bRequired = false },
            { Name = "GroupRole", ValueType = "Name", bRequired = false },
            { Name = "GroupMethod", ValueType = "Name", bRequired = false },
        },
    },
    StateMachine = {
    ...
    TwoBoneIK = {
        ...
        Properties = {
            { Name = "IKBone", ValueType = "Name", bRequired = true },
            { Name = "EffectorLocationSpace", ValueType = "Name", bRequired = false },
            { Name = "EffectorTargetBoneName", ValueType = "Name", bRequired = false },
            { Name = "EffectorTargetSocketName", ValueType = "Name", bRequired = false },
            { Name = "JointTargetLocationSpace", ValueType = "Name", bRequired = false },
            { Name = "JointTargetBoneName", ValueType = "Name", bRequired = false },
            { Name = "JointTargetSocketName", ValueType = "Name", bRequired = false },
            { Name = "AlphaInputType", ValueType = "Name", bRequired = false },
            { Name = "AlphaCurveName", ValueType = "Name", bRequired = false },
            { Name = "EffectorLocationX", ValueType = "Float", bRequired = false },
            { Name = "EffectorLocationY", ValueType = "Float", bRequired = false },
            { Name = "EffectorLocationZ", ValueType = "Float", bRequired = false },
            { Name = "JointTargetLocationX", ValueType = "Float", bRequired = false },
            { Name = "JointTargetLocationY", ValueType = "Float", bRequired = false },
            { Name = "JointTargetLocationZ", ValueType = "Float", bRequired = false },
            { Name = "StartStretchRatio", ValueType = "Float", bRequired = false },
            { Name = "MaxStretchScale", ValueType = "Float", bRequired = false },
            { Name = "bTakeRotationFromEffectorSpace", ValueType = "Bool", bRequired = false },
            { Name = "bAllowStretching", ValueType = "Bool", bRequired = false },
        },
    },
    ...
    SaveCachedPose = {
        ...
        Properties = {
            { Name = "CacheName", ValueType = "String", bRequired = true },
        },
    },
    UseCachedPose = {
    ...
    BoolPropertyGetter = {
        ...
        GraphTypes = { Pose = true, StatePose = true },
        Pins = { { Name = "Value", Direction = "Output", DataType = "Bool", bAllowMultipleConnections = true } },
        Properties = { { Name = "PropertyName", ValueType = "Name", bRequired = true } },
    },
    FloatPropertyGetter = {
        NodeType = "FloatPropertyGetter",
        GraphTypes = { Pose = true, StatePose = true },
        Pins = { { Name = "Value", Direction = "Output", DataType = "Float", bAllowMultipleConnections = true } },
        Properties = { { Name = "PropertyName", ValueType = "Name", bRequired = true } },
    },
    BytePropertyGetter = {
        NodeType = "BytePropertyGetter",
        GraphTypes = { Pose = true, StatePose = true },
        Pins = { { Name = "Value", Direction = "Output", DataType = "Byte", bAllowMultipleConnections = true } },
        Properties = { { Name = "PropertyName", ValueType = "Name", bRequired = true } },
    },
    EnumPropertyGetter = {
        NodeType = "EnumPropertyGetter",
        GraphTypes = { Pose = true, StatePose = true },
        Pins = { { Name = "Value", Direction = "Output", DataType = "Enum", bAllowMultipleConnections = true } },
        Properties = { { Name = "PropertyName", ValueType = "Name", bRequired = true } },
    },
    BlendListByBool = {
        ...
        GraphTypes = { Pose = true, StatePose = true },
        Pins = {
            { Name = "TruePose", Direction = "Input", DataType = "Pose", bAllowMultipleConnections = false },
            { Name = "FalsePose", Direction = "Input", DataType = "Pose", bAllowMultipleConnections = false },
            { Name = "ActiveValue", Direction = "Input", DataType = "Bool", bAllowMultipleConnections = false },
            { Name = "Pose", Direction = "Output", DataType = "Pose", bAllowMultipleConnections = true },
        },
        Properties = { { Name = "BlendTime", ValueType = "Float", bRequired = false } },
    },
    BlendListByEnum = {
        NodeType = "BlendListByEnum",
        GraphTypes = { Pose = true, StatePose = true },
        Pins = {
            { Name = "DefaultPose", Direction = "Input", DataType = "Pose", bAllowMultipleConnections = false },
            { Name = "Pose0", Direction = "Input", DataType = "Pose", bAllowMultipleConnections = false },
            { Name = "Pose1", Direction = "Input", DataType = "Pose", bAllowMultipleConnections = false },
            { Name = "Pose2", Direction = "Input", DataType = "Pose", bAllowMultipleConnections = false },
            { Name = "Pose3", Direction = "Input", DataType = "Pose", bAllowMultipleConnections = false },
            { Name = "Pose4", Direction = "Input", DataType = "Pose", bAllowMultipleConnections = false },
            { Name = "Pose5", Direction = "Input", DataType = "Pose", bAllowMultipleConnections = false },
            { Name = "Pose6", Direction = "Input", DataType = "Pose", bAllowMultipleConnections = false },
            { Name = "Pose7", Direction = "Input", DataType = "Pose", bAllowMultipleConnections = false },
            { Name = "ActiveValue", Direction = "Input", DataType = "Enum", bAllowMultipleConnections = false },
            { Name = "Pose", Direction = "Output", DataType = "Pose", bAllowMultipleConnections = true },
        },
        Properties = {
