...
#include "LuaAnimBlueprintFactoryLibrary.generated.h"
...
UCLASS()
class LUAANIMBLUEPRINTEDITOR_API ULuaAnimBlueprintFactoryLibrary : public UBlueprintFunctionLibrary
{
    GENERATED_BODY()

public:
    /** 在 transient package 中创建并编译原生 AnimBlueprint。 */
    UFUNCTION(BlueprintCallable, Category = "Lua|Animation|Factory")
    ...
    UFUNCTION(BlueprintCallable, Category = "Lua|Animation|Skeletal Mesh")
