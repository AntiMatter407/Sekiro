#include "LuaAnimSnapshotViewer.h"
...
namespace LuaAnimSnapshotViewerPrivate
{
/**
 ...
 */
FString GetNodeDisplayName(const TSharedPtr<FLuaAnimSnapshotNode>& Node)
{
 ...
 */
void SLuaAnimSnapshotViewer::Construct(const FArguments& InArgs)
{
    ChildSlot
    [
        SNew(SBorder)
        ...
        [
            ...
            [
                ...
                [
                    ...
                    .OnClicked(this, &SLuaAnimSnapshotViewer::HandleOpenFile)
                ]
                + SHorizontalBox::Slot()
                .AutoWidth()
                .Padding(0.0f, 0.0f, 6.0f, 0.0f)
                [
                    ...
                    .OnClicked(this, &SLuaAnimSnapshotViewer::HandleRefresh)
                ]
                + SHorizontalBox::Slot()
                .AutoWidth()
                ...
                [
                    ...
                    .OnClicked(this, &SLuaAnimSnapshotViewer::HandleLoadLatest)
                ]
                + SHorizontalBox::Slot()
                .AutoWidth()
                .Padding(0.0f, 0.0f, 6.0f, 0.0f)
                [
                    ...
                    .OnClicked(this, &SLuaAnimSnapshotViewer::HandleFitAll)
                ]
                + SHorizontalBox::Slot()
                .AutoWidth()
                [
                    ...
                    .OnClicked(this, &SLuaAnimSnapshotViewer::HandleResetView)
                ]
            ]
            + SVerticalBox::Slot()
            .AutoHeight()
            ...
            .AutoHeight()
            [
                SAssignNew(Timeline, SLuaAnimSnapshotTimeline)
                .Frames(&Document.Frames)
                .OnSnapshotSelected(this, &SLuaAnimSnapshotViewer::HandleTimelineSelection)
            ]
            + SVerticalBox::Slot()
            .AutoHeight()
            ...
            [
                ...
                [
                    ...
                    [
                        ...
                        .OnTextChanged(
                            this,
                            &SLuaAnimSnapshotViewer::HandleFrameSearchChanged)
                    ]
                    + SVerticalBox::Slot()
                    .FillHeight(1.0f)
                    [
                        SAssignNew(FrameList, SListView<TSharedPtr<FLuaAnimSnapshotFrame>>)
                        .ListItemsSource(&FilteredFrames)
                        .SelectionMode(ESelectionMode::Single)
                        .OnGenerateRow(this, &SLuaAnimSnapshotViewer::GenerateFrameRow)
                        .OnSelectionChanged(
                            this,
                            &SLuaAnimSnapshotViewer::HandleFrameSelectionChanged)
                    ]
                ]
                + SSplitter::Slot()
                .Value(0.36f)
                [
                    ...
                    .FillHeight(1.0f)
                    [
                        SAssignNew(NodeTree, STreeView<TSharedPtr<FLuaAnimSnapshotNode>>)
                        .TreeItemsSource(&NodeTreeRoots)
                        .SelectionMode(ESelectionMode::Single)
                        .OnGenerateRow(this, &SLuaAnimSnapshotViewer::GenerateNodeRow)
                        .OnGetChildren(this, &SLuaAnimSnapshotViewer::GetNodeChildren)
                        .OnSelectionChanged(
                            this,
                            &SLuaAnimSnapshotViewer::HandleNodeSelectionChanged)
                    ]
                ]
                + SSplitter::Slot()
                .Value(0.42f)
 ...
 */
bool SLuaAnimSnapshotViewer::DoesFrameMatchSearchForTesting(
    const TSharedPtr<FLuaAnimSnapshotFrame>& Frame,
    const FString& SearchText)
{
    return LuaAnimSnapshotViewerPrivate::DoesFrameMatchSearch(
        Frame,
 ...
 */
FReply SLuaAnimSnapshotViewer::HandleOpenFile()
{
 ...
 */
FReply SLuaAnimSnapshotViewer::HandleRefresh()
{
 ...
 */
FReply SLuaAnimSnapshotViewer::HandleLoadLatest()
{
    const FString LatestFile = FindLatestSnapshotFile();
    if (LatestFile.IsEmpty())
    {
        Document = FLuaAnimSnapshotDocument();
...
FReply SLuaAnimSnapshotViewer::HandleFitAll()
{
...
FReply SLuaAnimSnapshotViewer::HandleResetView()
{
 ...
 */
void SLuaAnimSnapshotViewer::HandleFrameSearchChanged(
 ...
 */
void SLuaAnimSnapshotViewer::LoadFile(const FString& FilePath)
{
    FLuaAnimSnapshotLoader::LoadFile(FilePath, Document);
    SelectedFrameArrayIndex = INDEX_NONE;
    SelectedNode.Reset();
    NodeTreeRoots.Reset();
    if (Timeline.IsValid()) Timeline->SetFrames(&Document.Frames);
 ...
 */
void SLuaAnimSnapshotViewer::RefreshFrameFilter()
{
    FilteredFrames.Reset();
    for (const TSharedPtr<FLuaAnimSnapshotFrame>& Frame : Document.Frames)
    {
        if (LuaAnimSnapshotViewerPrivate::DoesFrameMatchSearch(
            Frame,
            FrameSearchText))
        {
    ...
    {
        const TSharedPtr<FLuaAnimSnapshotFrame>& SelectedFrame =
 ...
 */
FString SLuaAnimSnapshotViewer::FindLatestSnapshotFile() const
{
 ...
 */
void SLuaAnimSnapshotViewer::SelectFrameByArrayIndex(const int32 FrameArrayIndex)
{
    ...
    if (NodeTree.IsValid())
    {
        ...
        NodeTree->RequestTreeRefresh();
        for (const TSharedPtr<FLuaAnimSnapshotNode>& Root : NodeTreeRoots)
        {
 ...
 */
void SLuaAnimSnapshotViewer::HandleTimelineSelection(const int32 FrameArrayIndex)
{
 ...
 */
void SLuaAnimSnapshotViewer::HandleFrameSelectionChanged(
 ...
 */
void SLuaAnimSnapshotViewer::HandleNodeSelectionChanged(
 ...
 */
TSharedRef<ITableRow> SLuaAnimSnapshotViewer::GenerateFrameRow(
    TSharedPtr<FLuaAnimSnapshotFrame> Frame,
    const TSharedRef<STableViewBase>& OwnerTable) const
{
    ...
    if (Frame.IsValid())
    {
        ...
        ToolTipText = FString::Printf(
            ...
            *Frame->ChangeTitle,
            *Frame->ChangeDetails,
            *LuaAnimSnapshotViewerPrivate::GetReasonLabel(Frame->CaptureReason),
            *Frame->UtcTimestamp);
    }
    return SNew(STableRow<TSharedPtr<FLuaAnimSnapshotFrame>>, OwnerTable)
    [
        SNew(SBorder)
        .BorderImage(FAppStyle::GetBrush(TEXT("ToolPanel.GroupBorder")))
 ...
 */
TSharedRef<ITableRow> SLuaAnimSnapshotViewer::GenerateNodeRow(
    TSharedPtr<FLuaAnimSnapshotNode> Node,
    const TSharedRef<STableViewBase>& OwnerTable) const
{
    FString RowText = LuaAnimSnapshotViewerPrivate::GetNodeDisplayName(Node);
    if (Node.IsValid())
    {
    ...
    return SNew(STableRow<TSharedPtr<FLuaAnimSnapshotNode>>, OwnerTable)
    [
        SNew(STextBlock)
 ...
 */
void SLuaAnimSnapshotViewer::GetNodeChildren(
    TSharedPtr<FLuaAnimSnapshotNode> Node,
 ...
 */
void SLuaAnimSnapshotViewer::ExpandNodeRecursively(
    TSharedPtr<FLuaAnimSnapshotNode> Node)
{
 ...
 */
void SLuaAnimSnapshotViewer::UpdateStatus()
{
 ...
 */
void SLuaAnimSnapshotViewer::UpdateDetails()
{
 ...
 */
FString SLuaAnimSnapshotViewer::BuildNodeDetails() const
{
    if (!Document.Frames.IsValidIndex(SelectedFrameArrayIndex))
    {
        return TEXT("请选择一个快照。");
    ...
    FString Details = FString::Printf(
        TEXT("别名：%s\n节点类型：%s\n节点权重：%.4f\nLua 动画名：%s\n原生资产名：%s\n输出类型：%s\n\n"),
        *LuaAnimSnapshotViewerPrivate::GetNodeDisplayName(SelectedNode),
        *SelectedNode->NodeType,
        SelectedNode->AbsoluteWeight,
        *SelectedNode->ResolvedAnimationName,
        *SelectedNode->NativeAssetName,
        *SelectedNode->OutputKind);
    LuaAnimSnapshotViewerPrivate::AppendStringMap(
        TEXT("输入参数"),
        SelectedNode->Inputs,
        Details);
    Details += TEXT("\n");
    LuaAnimSnapshotViewerPrivate::AppendNumberMap(
        TEXT("状态权重"),
 ...
 */
FString SLuaAnimSnapshotViewer::BuildFrameValueDetails() const
{
    if (!Document.Frames.IsValidIndex(SelectedFrameArrayIndex))
    {
        return TEXT("请选择一个快照。");
 ...
 */
FString SLuaAnimSnapshotViewer::BuildTransitionDetails() const
{
    if (!Document.Frames.IsValidIndex(SelectedFrameArrayIndex))
    {
        return TEXT("请选择一个快照。");
    ...
    TArray<FLuaAnimTransitionSample> SortedSamples = Frame->Transitions;
    SortedSamples.StableSort([](
        const FLuaAnimTransitionSample& Left,
        const FLuaAnimTransitionSample& Right)
    {
    ...
    for (const FLuaAnimTransitionSample& Sample : SortedSamples)
    {
        ...
        if (TransitionId != PreviousTransitionId)
        {
            ...
            for (const FLuaAnimTransitionSample& Candidate : SortedSamples)
            {
