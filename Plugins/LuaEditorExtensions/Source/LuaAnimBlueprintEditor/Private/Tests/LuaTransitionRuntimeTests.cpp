...
namespace LuaTransitionRuntimeTests
{
    /**
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FLuaTransitionRuntimeDirectTest,
    "Lua.AnimGraphIR.Runtime.DirectTransitionRule",
 ...
 */
bool FLuaTransitionRuntimeDirectTest::RunTest(const FString& Parameters)
{
    const FString ModuleName(TEXT("LuaAnimGraphIRTests.RuntimeDirectTransition"));
    UnLua::FLuaEnv* Environment = LuaTransitionRuntimeTests::GetOrActivateEnvironment();
    ...
    TestTrue(TEXT("Runtime rule module is injected"), Environment->DoString(
        LuaTransitionRuntimeTests::BuildRuntimeRuleModuleChunk(ModuleName),
        TEXT("LuaAnimGraphIRTests.RuntimeTransitionCache.Inject")));
    ...
    TestTrue(
        ...
        Environment->DoString(MutationChunk, TEXT("LuaAnimGraphIRTests.RuntimeDirectTransition.Mutate")));
    TestFalse(
