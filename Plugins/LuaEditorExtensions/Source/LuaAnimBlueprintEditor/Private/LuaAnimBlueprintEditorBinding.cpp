...
#define LOCTEXT_NAMESPACE "LuaAnimBlueprintEditorBinding"

DEFINE_LOG_CATEGORY_STATIC(LogLuaAnimBlueprintEditorBinding, Log, All);

namespace
{
    const FName CheckLuaToolbarBlockName(TEXT("Lua.CheckLua"));
    const FName GenerateFromLuaToolbarBlockName(TEXT("Lua.GenerateFromLua"));
    const FName ExportToLuaToolbarBlockName(TEXT("Lua.ExportToLua"));
    const FName SyncStatusToolbarBlockName(TEXT("Lua.SyncStatus"));
    const FName EditorLuaDebugToolbarBlockName(TEXT("Lua.EditorLuaDebug"));
    const FName LuaModuleToolbarBlockName(TEXT("Lua.LuaModule"));
    const TCHAR* EditorLuaDebugConfigSection = TEXT("LuaAnimBlueprintEditor.LuaDebug");
    ...
    void LogDiagnostics(
        ...
        const TArray<FLuaAnimIRDiagnostic>& Diagnostics)
    {
        for (const FLuaAnimIRDiagnostic& Diagnostic : Diagnostics)
        {
            if (Diagnostic.Severity == ELuaAnimIRDiagnosticSeverity::Error)
            {
                UE_LOG(
                    LogLuaAnimBlueprintEditorBinding,
                    Error,
                    TEXT("%s [%s] %s: %s (%s:%d:%d)"),
                    Operation,
 ...
 */
void FLuaAnimBlueprintEditorBinding::PrepareEditorLuaDebugBeforeEnvCreation()
{
 ...
 */
bool FLuaAnimBlueprintEditorBinding::ApplyEditorLuaDebugSetting()
{
 ...
 */
bool FLuaAnimBlueprintEditorBinding::IsEditorLuaDebugEnabled()
{
    bool bEnabled = false;
    if (GConfig != nullptr)
    {
 ...
 */
TSharedRef<FLuaAnimBlueprintEditorBinding>
FLuaAnimBlueprintEditorBinding::Create(
    const TSharedRef<FUICommandList>& CommandList,
    const TSharedRef<IAnimationBlueprintEditor>& Editor)
{
    return MakeShareable(new FLuaAnimBlueprintEditorBinding(
        CommandList,
        Editor,
        nullptr));
}
 ...
 */
TSharedRef<FExtender> FLuaAnimBlueprintEditorBinding::GetToolbarExtender()
{
    if (!ToolbarExtender.IsValid())
    {
        ...
        ToolbarExtender->AddToolBarExtension(
            ...
            FToolBarExtensionDelegate::CreateSP(
                SharedThis(this),
                &FLuaAnimBlueprintEditorBinding::FillToolbar));
    }
 ...
 */
void FLuaAnimBlueprintEditorBinding::FillToolbar(FToolBarBuilder& ToolbarBuilder)
{
    ...
    // 资产没有有效 Lua 源或正在 PIE 时，操作本身不可执行；不注册灰色按钮，避免误导。
    if (CanExecuteLuaAction())
    {
        ToolbarBuilder.AddToolBarButton(
            FUIAction(
                FExecuteAction::CreateSP(this, &FLuaAnimBlueprintEditorBinding::ExecuteCheckLua),
                FCanExecuteAction::CreateSP(this, &FLuaAnimBlueprintEditorBinding::CanExecuteLuaAction)),
        ...
        ToolbarBuilder.AddToolBarButton(
            FUIAction(
                FExecuteAction::CreateSP(this, &FLuaAnimBlueprintEditorBinding::ExecuteGenerateFromLua),
                FCanExecuteAction::CreateSP(this, &FLuaAnimBlueprintEditorBinding::CanExecuteLuaAction)),
        ...
        ToolbarBuilder.AddToolBarButton(
            FUIAction(
                FExecuteAction::CreateSP(this, &FLuaAnimBlueprintEditorBinding::ExecuteExportToLua),
                FCanExecuteAction::CreateSP(this, &FLuaAnimBlueprintEditorBinding::CanExecuteLuaAction)),
            ExportToLuaToolbarBlockName,
            LOCTEXT("ExportToLuaLabel", "AnimBlueprint → Lua"),
            LOCTEXT("ExportToLuaTooltip", "Explicitly export AnimGraph, state machines, transitions, and layout to a generated Lua exchange module. Native EventGraph logic stays in the AnimBlueprint and handwritten Lua is never overwritten."),
            FSlateIcon(FAppStyle::GetAppStyleSetName(), "Icons.Save"));
        ToolbarBuilder.AddToolBarButton(
            FUIAction(
                FExecuteAction::CreateSP(this, &FLuaAnimBlueprintEditorBinding::ExecuteRefreshSyncStatus),
                FCanExecuteAction::CreateSP(this, &FLuaAnimBlueprintEditorBinding::CanExecuteLuaAction)),
            SyncStatusToolbarBlockName,
            TAttribute<FText>::CreateSP(this, &FLuaAnimBlueprintEditorBinding::GetSyncStatusText),
    ...
    ToolbarBuilder.AddWidget(
        ...
        .Text(this, &FLuaAnimBlueprintEditorBinding::GetLuaModuleNameText)
        ...
        .IsEnabled(this, &FLuaAnimBlueprintEditorBinding::CanEditLuaModule)
        .OnTextCommitted(this, &FLuaAnimBlueprintEditorBinding::CommitLuaModuleName),
        LuaModuleToolbarBlockName);
    ToolbarBuilder.AddToolBarButton(
        FUIAction(
            FExecuteAction::CreateSP(this, &FLuaAnimBlueprintEditorBinding::ExecuteToggleEditorLuaDebug),
            FCanExecuteAction::CreateSP(this, &FLuaAnimBlueprintEditorBinding::CanToggleEditorLuaDebug),
            FIsActionChecked::CreateSP(this, &FLuaAnimBlueprintEditorBinding::IsEditorLuaDebugChecked)),
        EditorLuaDebugToolbarBlockName,
        TAttribute<FText>::CreateSP(this, &FLuaAnimBlueprintEditorBinding::GetEditorLuaDebugLabel),
        LOCTEXT(
 ...
 */
bool FLuaAnimBlueprintEditorBinding::IsValid() const
{
 ...
 */
bool FLuaAnimBlueprintEditorBinding::UsesCommandList(
 ...
 */
FLuaAnimBlueprintEditorBinding::FLuaAnimBlueprintEditorBinding(
 ...
 */
UAnimBlueprint* FLuaAnimBlueprintEditorBinding::GetAnimBlueprint() const
{
 ...
 */
void FLuaAnimBlueprintEditorBinding::ExecuteCheckLua()
{
    UAnimBlueprint* AnimBlueprint = GetAnimBlueprint();
    if (EnsureLocalLuaExtension() == nullptr) return;
    TArray<FLuaAnimIRDiagnostic> Diagnostics;
    const bool bSucceeded = ULuaAnimBlueprintFactoryLibrary::CheckLuaAnimBlueprint(
        AnimBlueprint,
        Diagnostics);
 ...
 * Reader 无法解析迁移前旧图时同样允许用户明确确认覆盖，避免导入入口被旧节点永久阻断。
 */
void FLuaAnimBlueprintEditorBinding::ExecuteGenerateFromLua()
{
    UAnimBlueprint* AnimBlueprint = GetAnimBlueprint();
    ULuaAnimBlueprintExtension* Extension = EnsureLocalLuaExtension();
    if (Extension == nullptr) return;
    TArray<FLuaAnimIRDiagnostic> Diagnostics;
    const bool bSyncStatusReady =
        ULuaAnimBlueprintFactoryLibrary::RefreshLuaAnimBlueprintSyncStatus(
        AnimBlueprint,
        Diagnostics);
    if (!bSyncStatusReady)
    {
        ...
        if (FMessageDialog::Open(
                EAppMsgType::YesNo,
                LOCTEXT(
                    "ConfirmLuaImportWithoutSyncStatus",
                    "The existing Animation Blueprint Graph cannot be compared with the Lua source. Importing Lua will overwrite the Lua-owned Graph without preserving unsupported Blueprint-side nodes. Continue?"))
            != EAppReturnType::Yes)
        {
            return;
        }
    ...
    if (bSyncStatusReady
        && (Extension->SyncStatus == ELuaAnimBlueprintSyncStatus::BlueprintChanged
            || Extension->SyncStatus == ELuaAnimBlueprintSyncStatus::BothChanged)
        && FMessageDialog::Open(
            EAppMsgType::YesNo,
            LOCTEXT(
    ...
    const bool bSucceeded = ULuaAnimBlueprintFactoryLibrary::CompileLuaAnimBlueprintInPlace(
        AnimBlueprint,
        false,
        Diagnostics);
 ...
 */
void FLuaAnimBlueprintEditorBinding::ExecuteExportToLua()
{
    UAnimBlueprint* AnimBlueprint = GetAnimBlueprint();
    ULuaAnimBlueprintExtension* Extension = EnsureLocalLuaExtension();
    if (Extension == nullptr) return;
    TArray<FLuaAnimIRDiagnostic> Diagnostics;
    if (!ULuaAnimBlueprintFactoryLibrary::RefreshLuaAnimBlueprintSyncStatus(
        AnimBlueprint,
        Diagnostics))
    {
        LogDiagnostics(TEXT("Refresh Sync Status"), AnimBlueprint, Diagnostics);
    ...
    if ((Extension->SyncStatus == ELuaAnimBlueprintSyncStatus::LuaChanged
            || Extension->SyncStatus == ELuaAnimBlueprintSyncStatus::BothChanged)
        && FMessageDialog::Open(
            EAppMsgType::YesNo,
            LOCTEXT(
    ...
    const bool bSucceeded = ULuaAnimBlueprintFactoryLibrary::AnimBlueprintToLua(
        AnimBlueprint,
        GeneratedModuleName,
        Diagnostics,
        true);
    ...
    if (bSucceeded && !GeneratedModuleName.IsEmpty())
    {
        const FString RelativeGeneratedPath =
            GeneratedModuleName.Replace(TEXT("."), TEXT("/")) + TEXT(".lua");
        GeneratedPath = FPaths::ConvertRelativePathToFull(FPaths::Combine(
            UUnLuaFunctionLibrary::GetScriptRootPath(),
            RelativeGeneratedPath));
        FPaths::NormalizeFilename(GeneratedPath);
    }
    UE_LOG(
        LogLuaAnimBlueprintEditorBinding,
        Display,
        TEXT("AnimBlueprint → Lua %s for '%s'%s%s."),
        bSucceeded ? TEXT("succeeded") : TEXT("failed"),
        AnimBlueprint != nullptr ? *AnimBlueprint->GetPathName() : TEXT("None"),
        GeneratedModuleName.IsEmpty() ? TEXT("") : *FString::Printf(TEXT(" as '%s'"), *GeneratedModuleName),
        GeneratedPath.IsEmpty() ? TEXT("") : *FString::Printf(TEXT(" at '%s'"), *GeneratedPath));
}

/** 只读刷新并记录当前 Graph/Lua 同步状态，不触发导入、导出、编译或保存。 */
void FLuaAnimBlueprintEditorBinding::ExecuteRefreshSyncStatus()
{
    UAnimBlueprint* AnimBlueprint = GetAnimBlueprint();
    if (EnsureLocalLuaExtension() == nullptr) return;
    TArray<FLuaAnimIRDiagnostic> Diagnostics;
 ...
 */
bool FLuaAnimBlueprintEditorBinding::CanExecuteLuaAction() const
{
    UAnimBlueprint* AnimBlueprint = GetAnimBlueprint();
    const ULuaAnimBlueprintExtension* Extension =
        ULuaAnimBlueprintExtension::FindEffective(AnimBlueprint);
 ...
 */
bool FLuaAnimBlueprintEditorBinding::CanEditLuaModule() const
{
 ...
 */
ULuaAnimBlueprintExtension*
FLuaAnimBlueprintEditorBinding::EnsureLocalLuaExtension()
{
    UAnimBlueprint* AnimBlueprint = GetAnimBlueprint();
    ULuaAnimBlueprintExtension* LocalExtension =
    ...
    const ULuaAnimBlueprintExtension* EffectiveExtension =
        ULuaAnimBlueprintExtension::FindEffective(AnimBlueprint);
    ...
    if (!ULuaAnimBlueprintFactoryLibrary::ConfigureLuaAnimBlueprintSource(
            AnimBlueprint,
            InheritedModuleName))
    {
        return nullptr;
    ...
    return ULuaAnimBlueprintExtension::Find(AnimBlueprint);
}
 ...
 */
FText FLuaAnimBlueprintEditorBinding::GetLuaModuleNameText() const
{
    const ULuaAnimBlueprintExtension* Extension =
        ULuaAnimBlueprintExtension::FindEffective(GetAnimBlueprint());
 ...
 */
FText FLuaAnimBlueprintEditorBinding::GetSyncStatusText() const
{
    const ULuaAnimBlueprintExtension* Extension =
        ULuaAnimBlueprintExtension::Find(GetAnimBlueprint());
    const ELuaAnimBlueprintSyncStatus Status = Extension != nullptr
        ? Extension->SyncStatus
        : ELuaAnimBlueprintSyncStatus::NeverSynchronized;
    switch (Status)
    {
    case ELuaAnimBlueprintSyncStatus::InSync:
        return LOCTEXT("SyncStatusInSync", "Sync: In Sync");
    case ELuaAnimBlueprintSyncStatus::BlueprintChanged:
        return LOCTEXT("SyncStatusBlueprintChanged", "Sync: Blueprint Changed");
    case ELuaAnimBlueprintSyncStatus::LuaChanged:
        return LOCTEXT("SyncStatusLuaChanged", "Sync: Lua Changed");
    case ELuaAnimBlueprintSyncStatus::BothChanged:
        return LOCTEXT("SyncStatusBothChanged", "Sync: Both Changed");
    case ELuaAnimBlueprintSyncStatus::Error:
 ...
 */
void FLuaAnimBlueprintEditorBinding::CommitLuaModuleName(
 ...
 */
void FLuaAnimBlueprintEditorBinding::ExecuteToggleEditorLuaDebug()
{
 ...
 */
bool FLuaAnimBlueprintEditorBinding::CanToggleEditorLuaDebug() const
{
 ...
 */
bool FLuaAnimBlueprintEditorBinding::IsEditorLuaDebugChecked() const
{
    return IsEditorLuaDebugEnabled();
}
 ...
 */
FText FLuaAnimBlueprintEditorBinding::GetEditorLuaDebugLabel() const
{
    return IsEditorLuaDebugEnabled()
