...
// ============================================================================
// 帧级行为标志位掩码（与 SekiroTAEImporter 中 SekiroJTFlags 保持一致）
// ============================================================================
namespace
{
    constexpr uint32 Bit_DisableTurning      = 1 << 0;
    constexpr uint32 Bit_DisableMovement     = 1 << 1;
    constexpr uint32 Bit_DisableMapHit       = 1 << 2;
    constexpr uint32 Bit_EnableParry         = 1 << 3;
    constexpr uint32 Bit_DisableParry        = 1 << 4;
    constexpr uint32 Bit_DisableSpecial      = 1 << 5;
    constexpr uint32 Bit_DisableItem         = 1 << 6;
    constexpr uint32 Bit_Invincible          = 1 << 7;
    constexpr uint32 Bit_SetNoGravity        = 1 << 8;
    constexpr uint32 Bit_FlagAsDodging       = 1 << 9;
    constexpr uint32 Bit_InvokeDeath         = 1 << 10;
    constexpr uint32 Bit_LimitMoveSpeedWalk  = 1 << 11;
    constexpr uint32 Bit_LimitMoveSpeedDash  = 1 << 12;
    constexpr uint32 Bit_EnterMovement       = 1 << 13;
    constexpr uint32 Bit_ExitMovement        = 1 << 14;
    constexpr uint32 Bit_Staggered           = 1 << 15;
