...
#include "SekiroLuaBehaviorTreeTask.generated.h"
...
UENUM(BlueprintType)
enum class ESekiroLuaBehaviorTreeTaskResult : uint8
{
    Succeeded,
    Failed,
    InProgress,
...
class SEKIROLUABEHAVIORTREEEXT_API USekiroLuaBehaviorTreeTask : public UBTTaskNode
{
    GENERATED_BODY()
...
public:
    ...
    bool FinishLuaTask(ESekiroLuaBehaviorTreeTaskResult Result);
...
private:
    ...
    EBTNodeResult::Type ParseExecuteResult(
