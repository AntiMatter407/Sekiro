...
DECLARE_DELEGATE_RetVal(TSharedRef<SWidget>, FSekiroGameplayToolWidgetFactory);

class SEKIROGAMEPLAYEDITOR_API FSekiroGameplayEditorModule : public IModuleInterface
{
public:
    // ── 模块与扩展接口 ──
    virtual void StartupModule() override;
    virtual void ShutdownModule() override;
    static FSekiroGameplayEditorModule& Get();
    bool RegisterTool(FName ToolId, const FText& DisplayName, FSekiroGameplayToolWidgetFactory Factory);
...
private:
    ...
    struct FToolRegistration
    {
        ...
        FSekiroGameplayToolWidgetFactory Factory; // 按需创建界面的工厂
    };
