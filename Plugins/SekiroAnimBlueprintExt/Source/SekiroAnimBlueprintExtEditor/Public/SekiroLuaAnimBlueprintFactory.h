...
#include "SekiroLuaAnimBlueprintFactory.generated.h"

/** 创建附带 Lua 源模块元数据的标准 UAnimBlueprint。 */
UCLASS(HideCategories = Object)
class SEKIROANIMBLUEPRINTEXTEDITOR_API USekiroLuaAnimBlueprintFactory : public UFactory
{
    GENERATED_BODY()

public:
    USekiroLuaAnimBlueprintFactory();
