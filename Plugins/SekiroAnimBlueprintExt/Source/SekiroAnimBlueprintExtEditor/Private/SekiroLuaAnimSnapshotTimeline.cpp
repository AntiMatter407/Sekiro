 ...
 */
void SSekiroLuaAnimSnapshotTimeline::Construct(const FArguments& InArgs)
{
 ...
 */
void SSekiroLuaAnimSnapshotTimeline::SetFrames(
    const TArray<TSharedPtr<FSekiroLuaAnimSnapshotFrame>>* InFrames)
{
    Frames = InFrames;
 ...
 * 必须在游戏线程调用；越界值会清除高亮。
 */
void SSekiroLuaAnimSnapshotTimeline::SetSelectedFrameIndex(const int32 InFrameIndex)
{
 ...
 */
void SSekiroLuaAnimSnapshotTimeline::FitAll()
{
 ...
 * 必须在游戏线程调用；不会改变当前选中帧。
 */
void SSekiroLuaAnimSnapshotTimeline::ResetView()
{
...
FVector2D SSekiroLuaAnimSnapshotTimeline::ComputeDesiredSize(
 ...
 */
int32 SSekiroLuaAnimSnapshotTimeline::OnPaint(
    ...
    const bool bParentEnabled) const
{
    ...
    {
        const TSharedPtr<FSekiroLuaAnimSnapshotFrame>& Frame = (*Frames)[FrameArrayIndex];
 ...
 */
FReply SSekiroLuaAnimSnapshotTimeline::OnMouseButtonDown(
 ...
 */
FReply SSekiroLuaAnimSnapshotTimeline::OnMouseButtonUp(
    const FGeometry& MyGeometry,
    const FPointerEvent& MouseEvent)
{
    if (bPanning
 ...
 */
FReply SSekiroLuaAnimSnapshotTimeline::OnMouseMove(
    const FGeometry& MyGeometry,
    const FPointerEvent& MouseEvent)
{
 ...
 */
FReply SSekiroLuaAnimSnapshotTimeline::OnMouseWheel(
    const FGeometry& MyGeometry,
    const FPointerEvent& MouseEvent)
{
    const float Width = FMath::Max(MyGeometry.GetLocalSize().X, 1.0f);
 ...
 */
double SSekiroLuaAnimSnapshotTimeline::ScreenXToTime(
    const float LocalX,
 ...
 */
float SSekiroLuaAnimSnapshotTimeline::TimeToScreenX(
 ...
 */
int32 SSekiroLuaAnimSnapshotTimeline::FindNearestFrame(
    const float LocalX,
    const float Width) const
{
 ...
 */
FText SSekiroLuaAnimSnapshotTimeline::MakeFrameTooltip(const int32 FrameArrayIndex) const
{
