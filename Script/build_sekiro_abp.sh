...
echo "============================================"
echo "完成！"
echo "  BS_Sekiro_Locomotion → 创建完成（17 samples: Walk/Jog/Run/Sprint 四档速度）"
