...
对比 `.codex/rules/code-style.md` 检查：
...
对比 `.codex/agents/plugin-programmer.md` 检查：
...
对比 `.codex/agents/gameplay-programmer.md` 检查：
...
对比 `.codex/docs/tech-designs/` 和 `.codex/docs/breakdown/` 中的对应文档：
